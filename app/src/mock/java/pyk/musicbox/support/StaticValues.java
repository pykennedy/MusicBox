...
public class StaticValues {
  ...
  private static List<Track> spoofedTracks() {
    ...
    tracks.add(new Track(6, "Red", "Red", "Taylor Swift", "123"));
    tracks.add(new Track(7, "Treacherous", "Red", "Taylor Swift", "123"));
    tracks.add(new Track(8, "I Knew You Were Trouble", "Red", "Taylor Swift", "123"));
    tracks.add(new Track(9, "Hector Berlioz: Symphonie Fantastique, Op. 14 - 1. Rêveries, Passions", "07", "Lamoureux Concert Association Orchestra", "123"));
    ...
    tracks.add(new Track(16, "Johann Sebastion Bach: Brandenburg Concerto No 1 in F major. BWV1046 4-menuetto -Trio -polonaise", "04", "Various Artists", "123"));
    tracks.add(new Track(17, "Proprium Missae In Dedicatione Ecclesiae - Communio \"Domus Mea\"", "01", "Benedictine Monks Of Münsterschwarzach", "123"));
    tracks.add(new Track(18, "Proprium Missae In Dedicatione Ecclesiae - Introitus \"Terribilis Est Locus Iste\"", "01", "Benedictine Monks Of Münsterschwarzach", "123"));
    tracks.add(new Track(19, "Proprium Missae In Dedicatione Ecclesiae - Offertorium \"Domine Deus, In Simplicitate\"", "01", "Benedictine Monks Of Münsterschwarzach", "123"));
