...
public class AddToPlaylistListItemAdapterPresenter
    implements AddToPlaylistListItemAdapterContract.AddToPlaylistListItemAdapterPresenter {
  AddToPlaylistListItemAdapterContract.AddToPlaylistListItemAdapterView adapterView;
  ...
  public AddToPlaylistListItemAdapterPresenter(
      final AddToPlaylistListItemAdapterContract.AddToPlaylistListItemAdapterView adapterView,
      final AddToPlaylistFragment context) {
